        ...
        <div class="row height d-flex justify-content-center align-items-center">
            <div class="col-md-6">
                <div class="form">
                    ...
                    <a href="{{ route('index') }}"><span class="left-pan"><i class="bi bi-search"></i></span></a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card card-shadow rounded position-relative" style="width: 18rem;">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between">
                                <p class="fs-6 fw-normal fst-italic my-auto">Venduto da: {{ $announcement->user->name ?? '' }}</p>
                                <p class="fs-6 fw-normal fst-italic my-auto">Creato il: {{ $announcement->created_at->format('d/m/Y')}}</p>
                            </div>
