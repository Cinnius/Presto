                    ...
                    <div class="ms-3 my-3">
                        ...
                        <div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Name-Asc">
                                <label class="form-check-label" for="Name-Asc">Ordine Crescente</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Name-Desc">
                        ...
                        <div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Price_Asc">
                                <label class="form-check-label" for="Price_Asc">Ordine Crescente</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Price_Desc">
                        ...
                        <div>
                            ...
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Date_Asc">
                                <label class="form-check-label" for="Date_Asc">Ordine Crescente</label>
                            </div>
                            <div class="form-check">
                                <input class="form-check-input" type="radio" name="Sorting" id="Date_Desc">
