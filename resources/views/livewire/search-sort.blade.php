<div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-12 fixed-top sorting-Bar d-flex align-items-center">
                <select class="form-select" aria-label="Default select example" wire:model="categorySearch" style="width: 12vw;height:40px">
    ...
    <div class="container index-Position">
        <div class="row mt-md-5 ">
            <div class="col-12 mt-md-5 d-flex flex-column align-items-center"">
                {{-- Search Bar --}}
                ...
                <div wire:loading.class="opacity-75" class="col-12 col-md-4 py-4 d-flex justify-content-center">
                    <div class="card card-shadow rounded position-relative" style="width: 18rem;">
                        ...
                        <div class="position-absolute end-0 mt-3">
                            <a href="{{ route('categoryShow', ['category' => $announcement->category]) }}" class="text-decoration-none text-dark main-bg py-1 px-2 rounded me-3 "><i class="bi bi-bookmark-fill"></i>
